...
PARSER = argparse.ArgumentParser(description="Conceder acesso para um grupo de usuários a um grupo de repositórios do Gitlab")
PARSER.add_argument('--url', type=str, help="URL do Gitlab")
PARSER.add_argument('--token', type=str, help="Token de acesso ao Gitlab")
PARSER.add_argument('--projectGroupId', type=int, help="ID do grupo de repositórios")
...
if ARGS.projectGroupId is None:
...
GitlabAccessControlHelper.concederAcessoGrupoUsuariosGrupoRepositorios(ARGS.projectGroupId, ARGS.userGroupId, nivelAcesso, ARGS.verbose)
